...
public final class InstructionSet {
    ...
    /**
     * Enum for types of instructions. Used for parsing.
     */
    public static enum InstructionArgument {
         ...
         *            Size
         */
        InstructionArgument(final char charRepr, final int sz) {
            this.fChar = charRepr;
            this.size = sz;
        }
    ...
    /**
     * Represents a z80-instruction. Includes it opcode, how to pretty print it,
     * and its informal name.
     * @author arvid
     */
